            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-2">
                        <div class="card">
                            <div class="card-body">
                                {{-- <img id="product-image" src="" alt="Product Image" class="card-img-top"> --}}
                                <div class="card-body">
                                    <h5 id="product-name" class="card-title"></h5>
                                    <p id="product-description" class="card-text"></p>
                                    <p><strong>Price:</strong> <span id="product-price"></span></p>
                                    <p><strong>Department:</strong> <span id="product-department"></span></p>
                                    <p><strong>Class:</strong> <span id="product-class"></span></p>
                                    <p><strong>Subclass:</strong> <span id="product-subclass"></span></p>
